...
setwd("C:/Users/kemba/Downloads/supervised learning")
...
library(readxl)
Bike_Sales <- read_excel("C:/Users/kemba/Downloads/Bike_Sales.xlsx")
View(Bike_Sales)
Data = readxl::read_xlsx("C:/Users/kemba/Downloads/Bike_Sales.xlsx")
...
one.way <- aov(Revenue ~ Month, dataentry() = aData)
summary(one.way)
TukeyHSD(one.way)
